...
def main():
    ...
    if patient_name == 'Patient6':
        ...
        new_condition_name = "1Day OFF Rest 180sec"
        conditions_to_merge = ["1Day OFF Rest (EyeOpen)", "1Day OFF Rest (EyeClose)"]
        patient.merge_conditions(conditions_to_merge, new_condition_name, total_duration=180)

        new_condition_name = "1Day ON Rest 180sec"
        conditions_to_merge = ["1Day ON Rest (EyeOpen) 1", "1Day ON Rest (EyeOpen) 2", "1Day ON Rest (EyeOpen) 3", "1Day ON Rest (EyeClose)"]
        patient.merge_conditions(conditions_to_merge, new_condition_name, total_duration=180)
